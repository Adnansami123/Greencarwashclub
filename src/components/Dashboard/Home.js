...
import { useGet_DashboardMutation } from '../../store/Dashboard/DashboardAPI';
...
useEffect(() => {
      ...
      setcount([
        {
          ...
          title: !!dashboardData ? dashboardData.userCount : null,
          persent: "",
          icon: heart,
          bnb: "bnb2",
        },
        ...
        },
        {
          ...
          totalPPMScheduleOverdue: "2",
          totalPPMSchedulePending: "3",
          title: !!dashboardData ? dashboardData.totalPayoutCompleted : null,
          persent: "",
          icon: upcoming,
          bnb: "bnb2",
        },
        // {
        //   today: "Total Withdraw Pending",
        //   key: "Survey",
        //   AssetName: "Upcoming Survey(s)",
        //   totalPPMSchedule: "10",
        //   totalPPMScheduleCompleted: "5",
        //   totalPPMScheduleOverdue: "2",
        //   totalPPMSchedulePending: "3",
        //   title: !!dashboardData ? dashboardData.totalPayoutPending : null,
        //   persent: "",
        //   icon: upcoming,
        //   bnb: "bnb2",
        // },
  ...
  const OnSuccessHandler = (e) => {
    console.log("OnSuccessHandler", e.clientXid);
    console.log("OnSuccessHandler" + e.clientXid);

    ...
    <>
      <>
        <section className="hero">
          {/* SINGLE VIDEO */}
          <video
            key={videos[current]} // important change
            autoPlay
            muted
            playsInline
          ...
          <div className="hero-content">
            <h1>Green Car Wash Club</h1>
            <p>Premium Car Care Experience</p>
            <button className="btn">Explore Plans</button>
          </div>
        </section>
        ...
        <section className="section light-bg">
          ...
          <p className="subtitle">
            We deliver top-quality car care with advanced equipment and expert
            staff. Our focus is on providing fast, reliable, and affordable
            services that keep your vehicle looking brand new every time.
          </p>
          <div className="cards">
            {[
              {
        ...
        <section className="section">
          <h2 className="title">Our Premium Car Services</h2>
          ...
          <div className="cards">
            {[
              ...
              },
              {
                ...
                points: ["Seat shampooing", "Dashboard polish", "Odor removal"],
              },
              {
                icon: <FaGem />,
              ...
              },
              {
                icon: <FaTools />,
                title: "Body Work",
                points: ["Dent repair", "Painting", "Full restoration"],
              },
              {
                icon: <FaCar />,
                title: "Car Accessories",
                points: ["Seat covers", "Lighting upgrades", "Custom add-ons"],
              },
              {
                icon: <FaGem />,
        ...
        <section className="section light-bg">
          <h2 className="title">Other Services We Offer</h2>
          <p className="subtitle">
            Beyond car washing, we provide complete vehicle solutions including
            buying, selling, finance, and exchange options — all in one place.
          </p>
            ...
            {[
              {
                icon: <FaCar />,
                title: "Vehicle Sales",
                desc: "Buy new & used vehicles at best prices with verified quality.",
              },
              {
                icon: <FaCar />,
                title: "Vehicle Purchase",
                desc: "Sell your old vehicle instantly with best market value.",
              },
              {
                icon: <FaDollarSign />,
                title: "Easy Finance Facility",
                desc: "Get quick loan approvals with low EMI and minimal documents.",
              },
              {
                icon: <FaExchangeAlt />,
                title: "Exchange Offers",
                desc: "Upgrade your vehicle with best exchange deals and offers.",
              },
              {
                icon: <FaShieldAlt />,
                title: "Insurance Assistance",
                desc: "Hassle-free vehicle insurance and claim support services.",
              },
              {
                icon: <FaTools />,
                title: "Full Maintenance",
                desc: "Complete servicing including repair, inspection, and care.",
              },
            ].map((item, i) => (
              <div key={i} className="card other-card animate-card">
                <div className="icon">{item.icon}</div>
                <h3>{item.title}</h3>
                <p>{item.desc}</p>

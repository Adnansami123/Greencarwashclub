...
import PurchaseVerificationDetails from "./PurchaseVerificationDetails";
        ...
        <>
            <div className="container">
                ...
                <Card
                    ...
                    title="Purchase & Payment Verification"
                >
                    <div class="row">
                        ...
                        {showKYCDetails == true ? <>
                            <div class="col-md-6">
                                <PurchaseVerificationDetails onCancel={(e) => onCancelHandler({ e })} onSuccess={(e) => OnSuccessHandlerNew({ e })} PurchaseID={KYCPurchaseID}></PurchaseVerificationDetails>
                            </div>
                        </>
                            : null}
